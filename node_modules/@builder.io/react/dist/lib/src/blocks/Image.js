...
var isNewReact = 'use' in react_1.default;
...
var ImageComponent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ImageComponent.prototype, "loadEagerly", {
        get: function () {
            var _a;
            return ((_a = this.props.builderBlock) === null || _a === void 0 ? void 0 : _a.id.startsWith('builder-pixel-')) || this.props.highPriority;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(ImageComponent.prototype, "fetchPriorityProp", {
        get: function () {
            var _a;
            var propNameToUse = isNewReact ? 'fetchPriority' : 'fetchpriority';
            return _a = {},
                _a[propNameToUse] = this.loadEagerly ? 'high' : 'auto',
                _a;
        },
        enumerable: false,
        configurable: true
    ...
    ImageComponent.prototype.render = function () {
        ...
        return ((0, core_1.jsx)(builder_meta_1.BuilderMetaContext.Consumer, null, function (value) {
            ...
            var imageContents = (!lazy || _this.state.load || amp) && ((0, core_1.jsx)(Tag, __assign({}, (amp
                ...
                : null), { alt: _this.props.altText, title: _this.props.title, key: sdk_1.Builder.isEditing
                    ...
                    _a))), loading: _this.loadEagerly ? 'eager' : 'lazy' }, _this.fetchPriorityProp, { className: 'builder-image' + (_this.props.className ? ' ' + _this.props.className : ''), src: _this.image }, (!amp && {
