...
var BuilderContent = /** @class */ (function (_super) {
    ...
    BuilderContent.prototype.render = function () {
        ...
        return (react_1.default.createElement(variants_provider_component_1.VariantsProvider, { initialContent: useData, nonce: this.props.nonce }, function (variants, renderScript) {
