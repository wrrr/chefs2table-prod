...
var VariantsProvider = function (_a) {
    var initialContent = _a.initialContent, children = _a.children, nonce = _a.nonce;
    ...
    if (sdk_1.Builder.isServer) {
        ...
        var renderScript = function () { return (React.createElement("script", { nonce: nonce, id: "variants-script-".concat(initialContent.id), dangerouslySetInnerHTML: {
